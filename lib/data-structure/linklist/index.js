 ...
 * @returns {*}
 */
Linklist.prototype.pop_back = function() {
    if(!this.length) {
        return undefined;
    }
 ...
 * @returns {*}
 */
Linklist.prototype.pop_front = function() {
    if(!this.length) {
        return undefined;
    }
 ...
 * @param value
 */
Linklist.prototype.push_back = function(value) {
    if(!(value instanceof LinklistNode)) {
        value = new LinklistNode(value);
    }
 ...
 * @param value
 */
Linklist.prototype.push_front = function(value) {
    if(!(value instanceof LinklistNode)) {
        value = new LinklistNode(value);
    }
